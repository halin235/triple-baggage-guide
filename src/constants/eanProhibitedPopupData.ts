...
export const EAN_JAPAN_PROHIBITED_POPUP_ITEMS: EanProhibitedPopupItem[] = [
  {
    ...
    itemName: "무선 고데기",
    detailText:
      "🚨 충전식 무선 고데기는 기내/위탁 모두 반입 불가함. 일본 공항에서 압수될 수 있으니 유선 제품을 챙길 것.",
  },
  {
    id: "ean-jp-2",
    itemName: "의약품 내, 수다페드 (슈도에페드린 성분)",
    detailText:
      "🚨 수다페드 성분은 일본 내 처벌 대상임. 한국 상비약이라도 성분을 꼭 확인하고 반입 금지.",
  },
];
...
export const EAN_KOREA_PROHIBITED_POPUP_ITEMS: EanProhibitedPopupItem[] = [
  {
    ...
    itemName: "컵형 곤약젤리",
    detailText:
      "🚨 컵형 곤약젤리는 한국 반입 시 전량 압수됨. 파우치(튜브)형 제품만 안전하게 가져올 수 있음.",
  },
  {
    id: "ean-kr-2",
    itemName: "소시지",
    detailText:
      "🚨 소시지는 가공 방식과 무관하게 반입이 금지됨. 적발 시 높은 과태료가 부과될 수 있음.",
  },
];
